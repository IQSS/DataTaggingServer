...
//        case None => {
//          models.add(vpmFd.toModel).map(vpm => Redirect(routes.PolicyKitManagementCtrl.showVpmPage(vpm.id)).flashing("message"->"Model '%s' created.".format(vpmFd.id)))
//        }
//        case Some(_) => {
